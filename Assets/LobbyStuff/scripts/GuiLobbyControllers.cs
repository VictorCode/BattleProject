...
public class ExitToLobbyCanvasControl : CanvasControl
{
	public override void Show()
	{
		...
		//	MIGHT NEED	EventSystem.current.firstSelectedGameObject = hooks.firstButton.gameObject;
		//	MIGHT NEED	EventSystem.current.SetSelectedGameObject(hooks.firstButton.gameObject);
	}
